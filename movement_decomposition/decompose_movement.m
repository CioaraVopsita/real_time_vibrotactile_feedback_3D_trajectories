...
%Random parameters
Dxr = -10+20*rand(1,no_submovements,50);
Dyr = -10+20*rand(1,no_submovements,50);Dzr = -10+20*rand(1,no_submovements,50);
Dr=0.167+0.833*rand(1,no_submovements,50); t0r = (repmat(time(length(time)),[1,no_submovements,50])-Dr).*rand(1,no_submovements,50);
...
options = optimset('GradObj','on','HessFcn', 'objective', 'LargeScale','on',...
